  ...
  head: () => ({
    meta: [
      ...
      { title: "FOMO — Nunca perca os eventos de Saquarema" },
      {
        name: "description",
        content:
          "Todos os eventos de Saquarema em um só app. Surf, música, cultura, gastronomia e mais. Faça check-in, ganhe XP e vire lenda da cidade.",
      },
      { property: "og:title", content: "FOMO — Nunca perca os eventos de Saquarema" },
      {
        property: "og:description",
        content: "Tudo acontece em Saquarema. Você só perde se quiser.",
      },
